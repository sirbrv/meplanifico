...
import ListTables from "./ListTableTipoIngreso";
import InfoModal from "../../../componets/Informacion";
import Pagination from "../../../componets/Pagination";
import "../../ab.css";

function HelpTipoIngreso({ onClose, handleSelect }) {
  ...
  const tittle = "Ayuda de Tipo de Ingresos";
...
export default HelpTipoIngreso;
