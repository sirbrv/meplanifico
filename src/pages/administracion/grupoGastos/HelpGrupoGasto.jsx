...
import ListTables from "./ListTableGrupoGasto";
import InfoModal from "../../../componets/Informacion";
import Pagination from "../../../componets/Pagination";
import "../../ab.css";

function HelpGrupoGastos({ onClose, handleSelect }) {
    ...
    axiosFetch({
      ...
      .then((response) => {
        if (response.status === "200") {
          setGrupoGastos(response.data.grupoGastos);
  ...
  const tittle = "Ayuda de Grupo de Gastos";
...
export default HelpGrupoGastos;
