...
import ListTables from "./ListTableTipoGasto";
import InfoModal from "../../../componets/Informacion";
import Pagination from "../../../componets/Pagination";
import "../../ab.css";

function HelpTipoGastos({ onClose, handleSelect }) {
    ...
    axiosFetch({
      ...
      .then((response) => {
        if (response.status === "200") {
          setTipoGastos(response.data.tipoGastos);
  ...
  const tittle = "Ayuda de Tipo de Gastos";
